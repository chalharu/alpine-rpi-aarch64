...
fetch_git kernel https://github.com/raspberrypi/linux.git rpi-5.2.y

fetch_file alpine-uboot-3.9.4-aarch64.tar.gz http://dl-cdn.alpinelinux.org/alpine/v3.9.4/releases/aarch64/alpine-uboot-3.9.4-aarch64.tar.gz
